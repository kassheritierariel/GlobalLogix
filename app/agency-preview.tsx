...
export default function AgencyPreviewScreen() {
  ...
  if (user?.role !== "super_admin") {
    return <ScreenContainer><View style={styles.denied}><MaterialIcon name="lock" size={34} color="#CE1126" /><Text style={styles.deniedTitle}>Accès éditeur requis</Text><Text style={styles.deniedText}>Seul le super administrateur peut prévisualiser l’espace d’une autre agence.</Text></View></ScreenContainer>;
  }
